use utf8;
package Spectrum::Result::FaSalesAmendmentRegister;
...
Sales Amendment Register store document detail of Sales Order Amendment.
...
=head1 TABLE: C<FaSalesAmendmentRegister>

=cut

__PACKAGE__->table("FaSalesAmendmentRegister");
...
Order Document Year from which detail has pickup.
...
Order Branch Code from which detail has pickup.
...
Order Document Type from which detail has pickup.
...
Order Series Code from which detail has pickup.
...
Order Document No. from which rate has to be pickup.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SF6IKqK92KoK6iY25MPXrg

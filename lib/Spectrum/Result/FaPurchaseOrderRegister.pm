use utf8;
package Spectrum::Result::FaPurchaseOrderRegister;
...
Purchase Order Register Stores single record for purchase order.
...
=head1 TABLE: C<FaPurchaseOrderRegister>

=cut

__PACKAGE__->table("FaPurchaseOrderRegister");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uVzqEv9Yke/5C2YyB6EJUQ

use utf8;
package Spectrum::Result::FaSalesOrderRegisterHistory;
...
Sales Order Register History stores each record for Sales Order before Sales Order Amendment has made.
...
=head1 TABLE: C<FaSalesOrderRegisterHistory>

=cut

__PACKAGE__->table("FaSalesOrderRegisterHistory");
...
=head2 fa_sales_order_products_histories
...
__PACKAGE__->has_many(
  "fa_sales_order_products_histories",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pGnZ2X8lylqjXgqcc+l2Yg

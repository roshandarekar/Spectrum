use utf8;
package Spectrum::Result::FaDeliveryChallanRegister;
...
Delivery Challan Register stores single record for Delivery Challan.
...
=head1 TABLE: C<FaDeliveryChallanRegister>

=cut

__PACKAGE__->table("FaDeliveryChallanRegister");
...
Entry Type (CLS - Sales, CLL - Labour Work, CLR - Challan  Return to Supplier)
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+caD8hkc4oRcimQ1EVls8A

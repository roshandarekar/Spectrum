use utf8;
package Spectrum::Result::FaSalesOrderScheduleHistory;
...
Sales Order Schedule History stores Delivery Schedule Details of Sales Order before Sales Order Amendment has made.
...
=head1 TABLE: C<FaSalesOrderScheduleHistory>

=cut

__PACKAGE__->table("FaSalesOrderScheduleHistory");
...
=head2 fa_sales_order_products_history

Type: belongs_to

Related object: L<Spectrum::Result::FaSalesOrderProductsHistory>

=cut

__PACKAGE__->belongs_to(
  "fa_sales_order_products_history",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tLyAIurxqDHA7HjuLL+i8A

use utf8;
package Spectrum::Result::FaSalesQuotationProduct;
...
Sales Quotation Products stores product Detail of Sales Quotation.
...
=head1 TABLE: C<FaSalesQuotationProducts>

=cut

__PACKAGE__->table("FaSalesQuotationProducts");
...
If Order has Received then Order Document Type. "SAO"
...
=head2 fa_sales_quotation_register
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nydTCAhCgRdindzUeVICag

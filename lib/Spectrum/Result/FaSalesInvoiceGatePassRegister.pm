use utf8;
package Spectrum::Result::FaSalesInvoiceGatePassRegister;
...
Sales Invoice GatePass Register Store Gatepass detail for Invoice & Credit Note to Customer if user select gatepass detail.
...
=head1 TABLE: C<FaSalesInvoiceGatePassRegister>

=cut

__PACKAGE__->table("FaSalesInvoiceGatePassRegister");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kvav0XHxgNcbHd6hKIpEgA

use utf8;
package Spectrum::Result::FaSalesAmendmentProduct;
...
Sales Amendment Products storers product Details of Sales Order Amendment.
...
=head1 TABLE: C<FaSalesAmendmentProducts>

=cut

__PACKAGE__->table("FaSalesAmendmentProducts");
...
=head2 fa_sales_amendment_register
...
=head2 fa_sales_amendment_schedules

Type: has_many

Related object: L<Spectrum::Result::FaSalesAmendmentSchedule>

=cut

__PACKAGE__->has_many(
  "fa_sales_amendment_schedules",
  "Spectrum::Result::FaSalesAmendmentSchedule",
  {
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:k8YePi+W7tJ7ovFJ1Dhc7w

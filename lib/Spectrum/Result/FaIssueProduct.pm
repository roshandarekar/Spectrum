use utf8;
package Spectrum::Result::FaIssueProduct;
...
Spectrum::Result::FaIssueProduct - Issue Products Stores product Detail Material Issue Note.
...
=head1 TABLE: C<FaIssueProducts>

=cut

__PACKAGE__->table("FaIssueProducts");
...
Issued Store Code in Case Material Issue or Received Store Code in case of Material Return.
...
=head2 fa_issue_register

Type: belongs_to

Related object: L<Spectrum::Result::FaIssueRegister>

=cut

__PACKAGE__->belongs_to(
  "fa_issue_register",
  "Spectrum::Result::FaIssueRegister",
  {
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NLAWcS+SUQpPnd6cHgd6xw

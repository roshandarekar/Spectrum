use utf8;
package Spectrum::Result::FaGoodInwardRegister;
...
Goods Inward Register Stores single Record of Goods Inward Note.
...
=head1 TABLE: C<FaGoodsInwardRegister>

=cut

__PACKAGE__->table("FaGoodsInwardRegister");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vPyqhdW7hx/mMCV5eWx71g

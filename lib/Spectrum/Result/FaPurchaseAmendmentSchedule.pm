use utf8;
package Spectrum::Result::FaPurchaseAmendmentSchedule;
...
Purchase Amendment Schedules store delivery schedule details for each items of Purchase Order Amendments if delivery schedule has selected.
...
=head1 TABLE: C<FaPurchaseAmendmentSchedule>

=cut

__PACKAGE__->table("FaPurchaseAmendmentSchedule");
...
=head2 fa_purchase_amendment_product
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rqzP4Ed3bHsCNurtydxj+A

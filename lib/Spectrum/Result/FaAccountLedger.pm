use utf8;
package Spectrum::Result::FaAccountLedger;
...
Spectrum::Result::FaAccountLedger - Account Ledger stores All Transactions of Accounts.
...
=head1 TABLE: C<FaAccountLedger>

=cut

__PACKAGE__->table("FaAccountLedger");
...
=head2 isvoucherprinted

  data_type: 'bit'
  is_nullable: 0

True if Voucher is Already Printed

=head2 isreceiptprinted

  data_type: 'bit'
  is_nullable: 0

True if Receipt is already printed

=head2 ischequeprinted

  data_type: 'bit'
  is_nullable: 0

True if cheque is already printed
...
True if Pay-in-Slip is already printed
...
=head2 fa_cost_centre_registers

Type: has_many

Related object: L<Spectrum::Result::FaCostCentreRegister>

=cut

__PACKAGE__->has_many(
  "fa_cost_centre_registers",
...
=head2 fa_expense_bill_register

Type: might_have

Related object: L<Spectrum::Result::FaExpenseBillRegister>

=cut

__PACKAGE__->might_have(
  "fa_expense_bill_register",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HKAqlunRSUb41+wq2VqZ5g

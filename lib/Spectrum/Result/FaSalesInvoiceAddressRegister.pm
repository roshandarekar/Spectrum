use utf8;
package Spectrum::Result::FaSalesInvoiceAddressRegister;
...
Sales Invoice Address Register store single record for Invoice, Cash Memo, Debit & Credit Note to Customers address detail if user select adress change.
...
=head1 TABLE: C<FaSalesInvoiceAddressRegister>

=cut

__PACKAGE__->table("FaSalesInvoiceAddressRegister");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OWHRbDshSVB9YUR1F1ZHzg

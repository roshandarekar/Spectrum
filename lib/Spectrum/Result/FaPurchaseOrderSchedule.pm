use utf8;
package Spectrum::Result::FaPurchaseOrderSchedule;
...
Purchase Order Schedule store delivery schedules detais of each purchase order items if user has selected delivery schedule.
...
=head1 TABLE: C<FaPurchaseOrderSchedule>

=cut

__PACKAGE__->table("FaPurchaseOrderSchedule");
...
=head2 fa_purchase_order_product
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/pRfrodKUrhjnNw98FDguA

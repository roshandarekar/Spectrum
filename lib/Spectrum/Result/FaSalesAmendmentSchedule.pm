use utf8;
package Spectrum::Result::FaSalesAmendmentSchedule;
...
Sales Amendment Schedule store delivery schedule detail of each items for Sales Order Amendment if user select delivery schedule.
...
=head1 TABLE: C<FaSalesAmendmentSchedule>

=cut

__PACKAGE__->table("FaSalesAmendmentSchedule");
...
=head2 fa_sales_amendment_product
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ay2h9jCOll86aBEMPFsj+Q

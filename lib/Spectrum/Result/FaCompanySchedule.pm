use utf8;
package Spectrum::Result::FaCompanySchedule;
...
Spectrum::Result::FaCompanySchedule

=head1 DESCRIPTION

Company Schedules Store Defination of Schedules to Print Schedules as Per Schedule 6 of Companies Act.
...
=head1 TABLE: C<FaCompanySchedules>

=cut

__PACKAGE__->table("FaCompanySchedules");
...
__PACKAGE__->set_primary_key("reporttype", "reportcode", "scheduleno", "sno");


# Created by DBIx::Class::Schema::Loader v0.07025 @ 2012-07-06 13:02:04
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HFeRCKxEKPRbecr47dqPEw

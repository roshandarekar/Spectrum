use utf8;
package Spectrum::Result::FaSalesOrderRegister;
...
Sales Order Register stores single record for each Sales Order.
...
=head1 TABLE: C<FaSalesOrderRegister>

=cut

__PACKAGE__->table("FaSalesOrderRegister");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BOvj6io+Wzl1Y/bfBqn+fg

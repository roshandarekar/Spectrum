use utf8;
package Spectrum::Result::FaSalesOrderProduct;
...
Spectrum::Result::FaSalesOrderProduct - Sales Order Products stores product detail of Sales Oorder.
...
=head1 TABLE: C<FaSalesOrderProducts>

=cut

__PACKAGE__->table("FaSalesOrderProducts");
...
=head2 fa_sales_order_schedules

Type: has_many

Related object: L<Spectrum::Result::FaSalesOrderSchedule>

=cut

__PACKAGE__->has_many(
  "fa_sales_order_schedules",
  "Spectrum::Result::FaSalesOrderSchedule",
  {
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dpBXW4roO9PsNiQx9qKr3w

use utf8;
package Spectrum::Result::FaPurchaseAmendmentProduct;
...
Purchase Amendment Products store Product Details of Purchase Order Amendents.
...
=head1 TABLE: C<FaPurchaseAmendmentProducts>

=cut

__PACKAGE__->table("FaPurchaseAmendmentProducts");
...
=head2 fa_purchase_amendment_register
...
__PACKAGE__->belongs_to(
  "fa_purchase_amendment_register",
...
=head2 fa_purchase_amendment_schedules

Type: has_many

Related object: L<Spectrum::Result::FaPurchaseAmendmentSchedule>

=cut

__PACKAGE__->has_many(
  "fa_purchase_amendment_schedules",
  "Spectrum::Result::FaPurchaseAmendmentSchedule",
  {
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5GzozJWgxD6+Kimp5GnNZw

use utf8;
package Spectrum::Result::FaSaleNoteAddressRegister;
...
SaleNote Address Register stores each record of SaleNote Address if user has selected change address.
...
=head1 TABLE: C<FaSaleNoteAddressRegister>

=cut

__PACKAGE__->table("FaSaleNoteAddressRegister");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NG+GaeEcGftLUT1HjweHdg

use utf8;
package Spectrum::Result::FaCostCentreProvisional;
...
CostCentre Provisional stores CostCentre Wise Provisional Entries.
...
=head1 TABLE: C<FaCostCentreProvisional>

=cut

__PACKAGE__->table("FaCostCentreProvisional");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:reL+IAxNAmEXBgRhsysFvw

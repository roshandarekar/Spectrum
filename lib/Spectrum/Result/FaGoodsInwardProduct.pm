use utf8;
package Spectrum::Result::FaGoodsInwardProduct;
...
Goods Inward Products stores product details of Goods Inward Note.
...
=head1 TABLE: C<FaGoodsInwardProducts>

=cut

__PACKAGE__->table("FaGoodsInwardProducts");
...
Reference Purchase Bill  Document Accounting Year.
...
Reference Purchase Bill  Company Branch Code.
...
Reference Purchase Bill  Document Type. "PUR"
...
Reference Purchase Bill  Document Series Code.
...
Reference Purchase Bill  Document No.
...
Reference Purchase Bill  Item Serial No. which can't change once saved.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:O16nR+jyCzoh23pwwbAaAA

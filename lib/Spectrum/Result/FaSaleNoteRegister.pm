use utf8;
package Spectrum::Result::FaSaleNoteRegister;
...
Spectrum::Result::FaSaleNoteRegister - SaleNote Register Stores single record for each SaleNote.
...
=head1 TABLE: C<FaSaleNoteRegister>

=cut

__PACKAGE__->table("FaSaleNoteRegister");
...
TRUE if user is required to Enter or change Address of Custoer for SaleNote..  Stored in FaSalesInvoiceAddressRegister Table.
...
=head2 fa_sale_note_address_register

Type: might_have

Related object: L<Spectrum::Result::FaSaleNoteAddressRegister>

=cut

__PACKAGE__->might_have(
  "fa_sale_note_address_register",
  "Spectrum::Result::FaSaleNoteAddressRegister",
  {
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cCUAANQo8OX0ykV9U132Xw

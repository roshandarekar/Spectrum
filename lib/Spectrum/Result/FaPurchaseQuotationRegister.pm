use utf8;
package Spectrum::Result::FaPurchaseQuotationRegister;
...
Purchase Quotation Register stores single record for Purchase Quotation.
...
=head1 TABLE: C<FaPurchaseQuotationRegister>

=cut

__PACKAGE__->table("FaPurchaseQuotationRegister");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6irAAmVMQMQCodBkEM2nMw

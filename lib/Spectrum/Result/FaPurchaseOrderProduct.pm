use utf8;
package Spectrum::Result::FaPurchaseOrderProduct;
...
Purchase Order Products stores product details of Purchase Order.
...
=head1 TABLE: C<FaPurchaseOrderProducts>

=cut

__PACKAGE__->table("FaPurchaseOrderProducts");
...
=head2 fa_purchase_order_register
...
=head2 fa_purchase_order_schedules

Type: has_many

Related object: L<Spectrum::Result::FaPurchaseOrderSchedule>

=cut

__PACKAGE__->has_many(
  "fa_purchase_order_schedules",
  "Spectrum::Result::FaPurchaseOrderSchedule",
  {
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:U69b1BrilOC+XBFr82wf7w

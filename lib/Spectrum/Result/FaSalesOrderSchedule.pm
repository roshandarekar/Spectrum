use utf8;
package Spectrum::Result::FaSalesOrderSchedule;
...
Sales Order Schedule stores delivery schedule detaiil of Sales Order before Sales Order Amendment has made.
...
=head1 TABLE: C<FaSalesOrderSchedule>

=cut

__PACKAGE__->table("FaSalesOrderSchedule");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6VaXDC6AtpjRo9BVLylv3A

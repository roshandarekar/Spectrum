use utf8;
package Spectrum::Result::FaPurchaseAmendmentRegister;
...
Purchase Amendment Register stores single record for each Purchase Order Amendment.
...
=head1 TABLE: C<FaPurchaseAmendmentRegister>

=cut

__PACKAGE__->table("FaPurchaseAmendmentRegister");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WA8l6oxO1Tzj+THgnYN3jw

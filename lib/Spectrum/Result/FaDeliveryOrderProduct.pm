use utf8;
package Spectrum::Result::FaDeliveryOrderProduct;
...
Delivery Order Product Stores Product Details of Delivery Order/Packing Slip.
...
=head1 TABLE: C<FaDeliveryOrderProducts>

=cut

__PACKAGE__->table("FaDeliveryOrderProducts");
...
=head2 fa_delivery_order_register
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:otzTXlfCdcADP/WD/i4SOg
